...
const OtpVerificationBox: React.FC<OtpVerificationBoxProps> = ({ verifyOtp, onSendotp, type, otpSent, verified, failed, disabled, setOtpSent, setVerified, setFailed, disable}) => {
